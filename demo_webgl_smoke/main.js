...
function initShowTextureShader() {
    ...
    showTextureRGBShader = CreateProgram("showTextureRGB.FS", "showTexture.VS");
...
function initFluidShader(frag_str, vert_str) {
    var shader = CreateProgram(frag_str, vert_str);
    ...
    shader.TsIsUniform = gl.getUniformLocation(shader, "uTsIs"); // 3d texture
    shader.IsTsUniform = gl.getUniformLocation(shader, "uIsTs"); // 3d texture scale
...
function initShaders() {
    ...
    advectDensityStepShader = initFluidShader("advectDensityStep.FS", "Fluid.VS");
    advectVelStepShader = initFluidShader("advectVelStep.FS", "Fluid.VS");
    setupPressureShader = initFluidShader("setupPressure.FS", "Fluid.VS");
    updateVelocityShader = initFluidShader("updateVelocity.FS", "Fluid.VS");
    solvePressureShader = initFluidShader("solvePressure.FS", "Fluid.VS");
    addSourceShader = initFluidShader("addSource.FS", "Fluid.VS");
    renderVolumeShader = initRenderVolumeShader("renderVolume.FS", "Fluid.VS");
}
