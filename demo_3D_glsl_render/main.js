    ...
    function render(){
        ...
        gl.uniform3fv(uniLocation[1], [1.0/width, 1.0/height, 1.0/Depth]);
    ...
    function Initialize(){
        ...
        w = GridWidth * 2;
        h = GridHeight * 2;
        HireObstacles = CreateSurface(w * Depth  ,h,1);
        CreateObstacles(HireObstacles, w * Depth, h);
        QuadVao = CreateQuad();  
